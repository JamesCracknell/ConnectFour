Public Class Main_Menu 'Main Menu of the program
    ...
    End Sub
    Private Sub Main_Menu_Setup() 'Starts the game based on inputted parameters
        ' Background Image
    ...
    End Sub
    Private Sub PlayerVsPlayerButton_Click(sender As Object, e As EventArgs)
        Me.Hide()
        Player_Vs_Player_Menu.This_Form_Setup()
    End Sub
    Private Sub PlayerVsComputerButton_Click(sender As Object, e As EventArgs)
        Me.Hide()
    ...
    End Sub
    Private Sub QuitButton_Click(sender As Object, e As EventArgs) 'if quitbutton is clicked
        Me.Close()
    End Sub
