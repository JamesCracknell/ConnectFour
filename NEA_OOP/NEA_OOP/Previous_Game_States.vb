Imports System.IO
Public Class Previous_Game_States
    ...
    ' Main Code
    Public Sub This_Form_Setup(DesiredGame)
        Me.Show()
    ...
    Sub Load_Previous_Game_State(DesiredGame)
    ...
    End Sub
    Public Function GetExtraInfo(DesiredGame)
    ...
    Public Sub SetUpExtraInfo(DesiredGame)
        ' Close Button
    ...
    End Sub
    Sub Convert1DArrayTo2DArray(LatestGameState) 'Converts grid to 2D array
