...
Public Class Game
    ...
    Public Sub GameOver(WinMode As String)
        ...
        Main_Menu.Show()
    End Sub
    Public Sub RecordGame(WinMode, WinningPlayer)
...
Public Class Player_Vs_Computer_Game
    ...
    Public Function EvaluateScore(EvaluatingSection() As Char, AnalysisColour As Char)
        ...
        For i = 0 To 3
            ...
            End If
        Next
        If NumberOfTilesInSequence = 1 And NumberOfOppositeTilesInSequence = 0 Then '1/4 of the tiles is filled 
            SectionScore += 0
        ElseIf NumberOfTilesInSequence = 2 And NumberOfOppositeTilesInSequence = 0 Then '2/4 of the tiles is filled
            SectionScore += 2
        ElseIf NumberOfTilesInSequence = 3 And NumberOfOppositeTilesInSequence = 0 Then '3/4 of the tiles is filled
            SectionScore += 10
